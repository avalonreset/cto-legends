...
| [legends-ultimate-captions](https://github.com/avalonreset/legends-ultimate-captions) 0.1.0 | Caption correction, timing, rendering, proof | Pip-installed CLI + skill; stdlib only, speech envs optional |
