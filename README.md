...
wheel command below installs the v0.5.2 release.

```sh
python -m pip install "https://github.com/avalonreset/cto-legends/releases/download/v0.5.2/cto_legends-0.5.2-py3-none-any.whl"
...
The v0.5.2 wheel linked above includes these commands.
